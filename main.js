            ...
            <div class="outside partCard">
                ...
                <div class="back">
                    ...
                    <ul class="funcList">
                        ...
                        <li style="--i: 2s;" class="func"><i class="fas fa-microchip"></i> Chức năng của sản phẩm</li>
                        <li style="--i: 3s;" class="func"><i class="fas fa-microchip"></i> Chức năng của sản phẩm</li>
                        <li style="--i: 4s;" class="func"><i class="fas fa-microchip"></i> Chức năng của sản phẩm</li>
